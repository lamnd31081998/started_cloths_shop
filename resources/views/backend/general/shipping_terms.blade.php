...
@section('title')
    Cài đặt trang chính sách giao hàng
@endsection
...
@section('right-navbar')
    ...
    <li class="breadcrumb-item active">Cài đặt trang chính sách giao hàng</li>
@endsection

@section('content')
    <div class="row">
        <div class="col-12 col-xl-12 col-sm-12 col-md-12 col-xs-12 col-xxl-12 col-lg-12">
            <form method="post" action="{{ route('be.general.update_shipping_terms') }}">
                @csrf
                @method('put')
                <div class="card card-primary">
                    <div class="card-header">
                        <h4 class="card-title">Cài đặt trang chính sách giao hàng</h4>
                    </div>
                    <div class="card-body">
...
@section('js')
    <script>
        function activelink() {
            ...
            $('#chinh-sach-giao-hang').addClass('active');
