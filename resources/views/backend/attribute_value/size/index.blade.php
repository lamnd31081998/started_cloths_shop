        ...
        <div class="col-12 col-lg-12 col-md-12 col-xl-12 col-sm-12">
            <div class="card card-primary" id="attribute_values_list">
                <div class="card-header">
                    <h4 class="card-title">Danh sách giá trị thuộc tính kích cỡ</h4>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <button type="button" onclick="select2()" class="btn btn-primary" data-toggle="modal" data-target="#create_size_values_modal">Thêm giá trị</button>

                        <div class="modal fade" id="create_size_values_modal" role="dialog">
                    ...
                    <div class="form-group table-responsive">
                        <table class="text-center table dataTable table-hover table-bordered dtr-inline" id="attribute_values_table">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Danh mục</th>
                            ...
                            <tbody>
                                @foreach($attribute_values as $attribute_value)
                                    <tr>
                                        ...
                                        <td><button title="Xóa giá trị" type="button" class="btn btn-danger" onclick="deleteAttributevalue({{ $attribute_value->id }})"><i class="fas fa-trash"></i></button></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
...
@section('js')
    ...
    <script>
        ...
        function createAttributevalues() {
            ...
            $.ajax({
               headers: {
                ...
                method: 'post',
                url: '{{ route('be.attribute_value.attribute_size.store') }}',
                data: {
        ...
        function deleteAttributevalue(size_id) {
            if (confirm("Bạn có chắc chắn muốn xóa giá trị này không?")) {
                $.ajax({
                    ...
                    method: 'delete',
                    url: '{{ route('be.attribute_value.attribute_size.delete') }}',
